...
public class INFO extends javax.swing.JDialog {
    ...
    public INFO(java.awt.Frame parent, boolean modal) {
        ...
        try
        {
            ...
            this.jLabel1.setText(ip.getHostName());
            this.jLabel2.setText(ip.getHostAddress());
        }
        catch(Exception e)
        {
            this.jLabel1.setText("DESCONOCIDO");
        }
        ...
        JP P[]=new JP[a.length];
        
        for (int i = 0; i < a.length; i++)
        {
            
            P[i]=new JP(a[i]);
            this.jTabbedPane1.add(a[i].toString(), P[i]);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aniox/36667354258.png"))); // NOI18N
        jLabel1.setText("NOMBRE DE LA PC");
