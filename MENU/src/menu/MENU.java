...
public class MENU {
    ...
    public static class BROWSER {
        ...
        BROWSER(String D) {
            ...
            for (int i = 0; i < A.length; i++) {
                ...
                if (b.isDirectory()) {
                    BROWSER OBJ = new BROWSER(a.getAbsolutePath() + "\\" + A[i]);
                }
            }
        }
    }
    ...
    public static class READ {
        ...
        READ() {
            ...
            while ("".equals(ruta) == true) { //CONDICIONES PARA QUE ENTRE 
                ...
                try {
                    ...
                    //OBTENCION DEL OBJETO TIPO FILE A PARTIR DE LA RUTA
        ...
        RUTA() {
            ...
            while ("".equals(ruta) == true) { //CONDICIONES PARA QUE ENTRE 
                ...
                try {
                    ...
                    if (a.exists()) {
                        System.out.println("Ha seleccionado " + ((a.isFile()) ? "el Archivo " : "la Carpeta ") + "\"" + a.getName() + "\"");
                    } else {
                        System.out.println("RUTA NO VALIDA");
                        ruta = "";
                    }
    ...
    public static void MENU() {
        ...
        //INICIALIZACION DE LA VARIABLE PARA QUE ENTRE EN EL MENU
        int opcion = 0;
    ...
    public static class OPCIONES {
        ...
        public void OPCION_3() {
            ...
            //VALIDACION LA ENTRADA
            DIR = "";
            while ("".equals(DIR)) { //ENTRA SI NO HAY DIRECTORIO
        ...
        public void OPCION_6() {
            ...
            //IMPRESION DE LA LISTA DE LAS UNIDADES DISPONIBLES6
        ...
        public void OPCION_7() {
            ...
            //INICIALISAR CLASE READ
            READ OBJ = new READ();

            try {
                //LECTOR DE ARCHIVOS .TXT
                java.io.BufferedReader L = new java.io.BufferedReader(new java.io.FileReader(OBJ.ruta));
    ...
    public static void main(String[] args) throws IOException {
        ...
        BROWSER OBJ=new BROWSER(d);
        
        
        File a=new File("F:\\RAUL\\YADEESER\\coco.txt");
